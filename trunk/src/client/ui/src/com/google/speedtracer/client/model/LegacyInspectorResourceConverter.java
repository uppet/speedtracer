...
/**
 * TODO (jaimeyap): Remove this class once WebKit r52154 gets pushed to Dev
 * Channel.
 * 
 * Utility class responsible for transforming inspector style network resources
 * for versions of WebKit older than r52154 into checkpoint style resources that
 * our UI expects.
 */
public class LegacyInspectorResourceConverter extends
