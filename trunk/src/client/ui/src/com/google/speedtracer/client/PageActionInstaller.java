 ...
 * manifest.
 */
@ManifestInfo(path = "page_action_installer.js", whiteList = {
    "http://*/*", "https://*/*", "file:///*"}, runAt = ContentScript.DOCUMENT_START)
public class PageActionInstaller extends ContentScript {
  public static final String NAME = "ENABLE_MONITOR_TAB_BUTTON";
}
